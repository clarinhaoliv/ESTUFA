...
from rest_framework import viewsets #viewsets: classes que agrupam vizualizações, como CRUD em uma unica classe
...
class LeituraViewSet(viewsets.ModelViewSet):
    ...
    def ultimas_24h(self, request):
        """retorna leituras das últimas 24horas"""
